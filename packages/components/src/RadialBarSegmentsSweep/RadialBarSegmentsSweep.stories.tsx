...
const meta: Meta<typeof RadialBarSegmentsSweep> = {
  title: 'RadialBarSegmentsSweep',
  component: RadialBarSegmentsSweep,
  decorators: (Story) => (
...
type Story = StoryObj<typeof RadialBarSegmentsSweep>;

const fullCircleCtx: RadialBarSegmentsSweepProps['ctx'] = {
  radialBarScale: {
    valueMin: 0,
    valueMax: 100,
    angleMin: 0,
...
const halfCircleCtx: RadialBarSegmentsSweepProps['ctx'] = {
  radialBarScale: {
    valueMin: 1,
    valueMax: 3,
