...
import { Unstable_Autocomplete, Unstable_AutocompleteProps } from '..';
import {
  containBoxShadow,
  enableHooks,
  Gear,
...
export default {
  ...
  component: Unstable_Autocomplete,
...
const Template = (args) => <Unstable_Autocomplete {...args} />;
...
> = DefaultStory<
  WithStoryPresets<
    Unstable_AutocompleteProps<T, Multiple, DisableClearable, FreeSolo>
  >
>;
