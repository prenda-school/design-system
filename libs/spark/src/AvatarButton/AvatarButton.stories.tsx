...
import { containFocusIndicator, inverseBackground, User } from '../../stories';

export const _retyped = AvatarButton as typeof AvatarButton;
...
const Template = (args) => <AvatarButton {...args} />;
