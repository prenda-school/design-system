...
export const _retyped = TextField as typeof TextField;
...
export default {
  ...
  argTypes: {
    children: {
      control: SelectMeta.argTypes.children.control,
      options: ['undefined'].concat(SelectMeta.argTypes.children.options),
      mapping: {
        undefined: undefined,
        ...SelectMeta.argTypes.children.mapping,
      },
    },
    leadingEl: {
      control: 'select',
...
type Story = DefaultStory<TextFieldProps>;
