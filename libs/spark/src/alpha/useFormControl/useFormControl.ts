import { useFormControl as useFormControl_mui } from '@material-ui/core/FormControl';
...
const useFormControl = (
  params: UseFormControlParams = {}
): UseFormControlResult => {
  const muiFormControl = useFormControl_mui();
