    ...
    >
      <g clipPath="url(#Pen_Tool_-_2_svg__clip0)">
        <path
          fill="currentcolor"
          fillRule="evenodd"
          d="M4.156 2.267a.75.75 0 00-.89.89l3 14a.75.75 0 00.627.585l5.517.789a2.164 2.164 0 003.12 3l6.5-6.5a2.164 2.164 0 00-2.48-3.477l-.809-5.66a.75.75 0 00-.585-.627l-14-3zm14.047 10.468l-.872-6.111L6.325 4.266l4.334 4.333a2.75 2.75 0 11-1.06 1.06L5.263 5.326l2.359 11.005 6.11.873 4.47-4.47zM14.53 18.53l-1 1a.664.664 0 00.94.94l6.5-6.5a.664.664 0 00-.94-.94l-.5.5-5 5zM12 9.75a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5z"
          clipRule="evenodd"
        />
      </g>
      <defs>
