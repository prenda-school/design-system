  ...
  return (
    ...
    >
      <path
        ...
        fillRule="evenodd"
        d="M5 9a7 7 0 1112.08 4.816C15.993 14.962 15 16.332 15 17.911V17s-1.5 1-3 1-3-1-3-1v.908c-.001-1.577-.994-2.947-2.08-4.092A6.976 6.976 0 015 9zm4 10v-1.092V19z"
        clipRule="evenodd"
      />
      <path
        fill="currentcolor"
