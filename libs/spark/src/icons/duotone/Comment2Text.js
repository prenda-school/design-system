  ...
  return (
    ...
    >
      ...
      <path
        ...
        fillOpacity={0.72}
        fillRule="evenodd"
        d="M12 3.75A8.25 8.25 0 003.75 12c0 .977.238 1.98.558 2.878l.005.014c.259.728.46 1.292.598 1.726.135.422.235.792.255 1.104.015.25.02.467-.008.697-.028.23-.087.44-.163.679-.09.284-.235.56-.416.859-.056.091-.117.189-.184.293H12a8.25 8.25 0 000-16.5zM2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75H3a.75.75 0 01-.624-1.166l.225-.337c.313-.47.534-.802.694-1.067.16-.264.234-.421.271-.538a2.24 2.24 0 00.104-.407 2.24 2.24 0 00-.001-.419c-.007-.108-.052-.319-.187-.741-.13-.408-.322-.95-.587-1.694-.354-.995-.645-2.175-.645-3.381zm5-2A.75.75 0 018 9.25h8a.75.75 0 010 1.5H8a.75.75 0 01-.75-.75zM8 13.25a.75.75 0 000 1.5h4a.75.75 0 000-1.5H8z"
        clipRule="evenodd"
      />
    </svg>
  );
